...
// Weather class
class LLVM_LIBRARY_VISIBILITY WeatherTargetInfo : public TargetInfo {
public:
  WeatherTargetInfo(const llvm::Triple &Triple, const TargetOptions &)
      : TargetInfo(Triple) {
    resetDataLayout(
        // Little-endian.
        "e-"
...
#endif // LLVM_CLANG_LIB_BASIC_TARGETS_WEATHER_H